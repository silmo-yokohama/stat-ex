...
export const mockPlayers: Player[] = [
  {
    id: id("player", 1),
    bleague_player_id: "10001",
    sportsnavi_player_id: "sp-1001",
    name: "田中 大輝",
    name_en: "Daiki Tanaka",
    number: 0,
    position: "PG",
    height: 178,
    weight: 75,
  ...
  {
    id: id("player", 2),
    bleague_player_id: "10002",
    sportsnavi_player_id: "sp-1002",
    name: "佐藤 健太",
    name_en: "Kenta Sato",
    number: 1,
    position: "SG",
  ...
  {
    id: id("player", 3),
    bleague_player_id: "10003",
    sportsnavi_player_id: "sp-1003",
    name: "高橋 翔",
    name_en: "Sho Takahashi",
    number: 3,
    position: "SF",
    height: 192,
    weight: 88,
  ...
  {
    id: id("player", 4),
    bleague_player_id: "10004",
    sportsnavi_player_id: "sp-1004",
    name: "渡辺 龍一",
    name_en: "Ryuichi Watanabe",
    number: 7,
    position: "PF",
    height: 198,
    weight: 95,
  ...
  {
    id: id("player", 5),
    bleague_player_id: "10005",
    sportsnavi_player_id: "sp-1005",
    name: "マイケル・ジョンソン",
  ...
  {
    id: id("player", 6),
    bleague_player_id: "10006",
    sportsnavi_player_id: "sp-1006",
    name: "鈴木 拓海",
  ...
  {
    id: id("player", 7),
    bleague_player_id: "10007",
    sportsnavi_player_id: "sp-1007",
    name: "伊藤 悠真",
    name_en: "Yuma Ito",
    number: 14,
    position: "SG",
  ...
  {
    id: id("player", 8),
    bleague_player_id: "10008",
    sportsnavi_player_id: "sp-1008",
    name: "中村 光太郎",
    name_en: "Kotaro Nakamura",
    number: 21,
    position: "SF",
    height: 190,
    weight: 86,
  ...
  {
    id: id("player", 9),
    bleague_player_id: "10009",
    sportsnavi_player_id: "sp-1009",
    name: "デイビッド・ウィリアムズ",
    name_en: "David Williams",
    number: 24,
    position: "PF",
    height: 200,
    weight: 100,
  ...
  {
    id: id("player", 10),
    bleague_player_id: "10010",
    sportsnavi_player_id: "sp-1010",
    name: "小林 慶介",
    name_en: "Keisuke Kobayashi",
    number: 30,
    position: "C",
    height: 202,
    weight: 103,
  ...
  {
    id: id("player", 11),
    bleague_player_id: "10011",
    sportsnavi_player_id: "sp-1011",
    name: "山本 駿",
    name_en: "Shun Yamamoto",
    number: 33,
    position: "PG",
    height: 180,
    weight: 76,
  ...
  {
    id: id("player", 12),
    bleague_player_id: "10012",
    sportsnavi_player_id: "sp-1012",
    name: "松田 陸",
    name_en: "Riku Matsuda",
    number: 40,
    position: "SF",
    height: 193,
    weight: 90,
  ...
  {
    id: id("player", 13),
    bleague_player_id: "10013",
    sportsnavi_player_id: "sp-1013",
    name: "クリス・テイラー",
    name_en: "Chris Taylor",
    number: 44,
    position: "PF",
    height: 201,
    weight: 102,
  ...
  {
    id: id("player", 14),
    bleague_player_id: "10014",
    sportsnavi_player_id: "sp-1014",
    name: "井上 颯太",
    name_en: "Sota Inoue",
    number: 5,
    position: "SG",
  ...
  {
    id: id("player", 15),
    bleague_player_id: "10015",
    sportsnavi_player_id: "sp-1015",
    name: "木村 大地",
    name_en: "Daichi Kimura",
    number: 8,
    position: "PF",
    height: 196,
    weight: 92,
...
export const mockTeamStats: TeamStats = {
  ...
  avg_points_for:
    Math.round(
      (finishedGames.reduce(
        (sum, g) => sum + (g.home_away === "HOME" ? g.score_home! : g.score_away!),
        0
      ) /
  ...
  avg_points_against:
    Math.round(
      (finishedGames.reduce(
        (sum, g) => sum + (g.home_away === "HOME" ? g.score_away! : g.score_home!),
        0
      ) /
        finishedGames.length) *
        10
...
export const mockStandings: Standing[] = [
  ...
  },
  {
    ...
    wins: totalWins,
    losses: totalLosses,
    win_pct: mockTeamStats.win_pct,
    games_behind: 3.0,
    points_for: mockTeamStats.avg_points_for,
    points_against: mockTeamStats.avg_points_against,
    point_diff:
      Math.round((mockTeamStats.avg_points_for! - mockTeamStats.avg_points_against!) * 10) / 10,
    streak: "W1",
    last5: "3-2",
    created_at: "2026-02-22T00:00:00+09:00",
    updated_at: "2026-02-22T00:00:00+09:00",
...
export const mockH2HRecords: H2HRecord[] = [
  {
    id: id("h2h", 1),
    season_id: mockSeason.id,
    opponent_team_id: id("team", 2),
    wins: 1,
    losses: 1,
    avg_points_for: 80.0,
    avg_points_against: 80.0,
    created_at: "2026-02-22T00:00:00+09:00",
    updated_at: "2026-02-22T00:00:00+09:00",
  },
  {
    id: id("h2h", 2),
    season_id: mockSeason.id,
    opponent_team_id: id("team", 3),
    wins: 1,
    losses: 1,
    avg_points_for: 83.0,
    avg_points_against: 81.0,
    created_at: "2026-02-22T00:00:00+09:00",
    updated_at: "2026-02-22T00:00:00+09:00",
  },
  {
    id: id("h2h", 3),
    season_id: mockSeason.id,
    opponent_team_id: id("team", 4),
    wins: 2,
    losses: 0,
    avg_points_for: 86.5,
    avg_points_against: 80.5,
    created_at: "2026-02-22T00:00:00+09:00",
    updated_at: "2026-02-22T00:00:00+09:00",
  },
  {
  ...
  },
  {
    id: id("h2h", 5),
    season_id: mockSeason.id,
    opponent_team_id: id("team", 6),
    wins: 1,
    losses: 1,
    avg_points_for: 83.0,
    avg_points_against: 82.0,
    created_at: "2026-02-22T00:00:00+09:00",
    updated_at: "2026-02-22T00:00:00+09:00",
  },
  {
    id: id("h2h", 6),
    season_id: mockSeason.id,
    opponent_team_id: id("team", 7),
    wins: 2,
    losses: 0,
    avg_points_for: 88.5,
    avg_points_against: 79.5,
    created_at: "2026-02-22T00:00:00+09:00",
    updated_at: "2026-02-22T00:00:00+09:00",
  },
  {
    id: id("h2h", 7),
    season_id: mockSeason.id,
    opponent_team_id: id("team", 8),
    wins: 2,
    losses: 0,
    avg_points_for: 83.0,
    avg_points_against: 75.0,
    created_at: "2026-02-22T00:00:00+09:00",
    updated_at: "2026-02-22T00:00:00+09:00",
  },
  {
  ...
  },
  {
    id: id("h2h", 10),
    season_id: mockSeason.id,
    opponent_team_id: id("team", 11),
    wins: 2,
    losses: 0,
    avg_points_for: 90.0,
    avg_points_against: 81.5,
    created_at: "2026-02-22T00:00:00+09:00",
    updated_at: "2026-02-22T00:00:00+09:00",
  },
  {
    id: id("h2h", 11),
    season_id: mockSeason.id,
    opponent_team_id: id("team", 12),
    wins: 1,
    losses: 1,
    avg_points_for: 89.5,
    avg_points_against: 87.0,
    created_at: "2026-02-22T00:00:00+09:00",
    updated_at: "2026-02-22T00:00:00+09:00",
  },
  {
  ...
  },
  {
    id: id("h2h", 13),
    season_id: mockSeason.id,
    opponent_team_id: id("team", 14),
    wins: 1,
    losses: 0,
    avg_points_for: 85.0,
    avg_points_against: 78.0,
    created_at: "2026-02-22T00:00:00+09:00",
    updated_at: "2026-02-22T00:00:00+09:00",
  },
];
...
export const mockNews: News[] = [
  {
    id: id("news", 1),
    source: "official",
    title: "【試合結果】2/21(金) vs 東京エクセレンス GAME1",
    url: "https://yokohama-ex.jp/news/game-result-0221",
    published_at: "2026-02-21T22:00:00+09:00",
    thumbnail_url: null,
    source_name: "横浜エクセレンス公式",
    created_at: "2026-02-21T22:30:00+09:00",
    updated_at: "2026-02-21T22:30:00+09:00",
  },
  {
    id: id("news", 2),
    source: "official",
    title: "2月後半 ホームゲームチケット発売のお知らせ",
    url: "https://yokohama-ex.jp/news/ticket-feb",
    published_at: "2026-02-18T12:00:00+09:00",
    thumbnail_url: null,
    source_name: "横浜エクセレンス公式",
    created_at: "2026-02-18T12:30:00+09:00",
    updated_at: "2026-02-18T12:30:00+09:00",
  },
  {
    id: id("news", 3),
    source: "official",
    title: "マイケル・ジョンソン選手 月間MVP受賞",
    url: "https://yokohama-ex.jp/news/mvp-johnson",
    published_at: "2026-02-15T10:00:00+09:00",
    thumbnail_url: null,
    source_name: "横浜エクセレンス公式",
    created_at: "2026-02-15T10:30:00+09:00",
    updated_at: "2026-02-15T10:30:00+09:00",
  },
  {
    id: id("news", 4),
    source: "official",
    title: "横浜武道館 来場者1万人達成記念イベント開催",
    url: "https://yokohama-ex.jp/news/10000-event",
    published_at: "2026-02-12T10:00:00+09:00",
    thumbnail_url: null,
    source_name: "横浜エクセレンス公式",
    created_at: "2026-02-12T10:30:00+09:00",
    updated_at: "2026-02-12T10:30:00+09:00",
  },
  {
    id: id("news", 5),
    source: "official",
    title: "新グッズ販売開始のお知らせ",
    url: "https://yokohama-ex.jp/news/new-goods",
    published_at: "2026-02-10T10:00:00+09:00",
    thumbnail_url: null,
    source_name: "横浜エクセレンス公式",
    created_at: "2026-02-10T10:30:00+09:00",
    updated_at: "2026-02-10T10:30:00+09:00",
  },
  {
    id: id("news", 6),
    source: "media",
    title: "横浜エクセレンス、B2昇格初年度で3位と好調 プレーオフ進出に期待",
    url: "https://example.com/news/yokohama-ex-b2",
    published_at: "2026-02-20T15:00:00+09:00",
    thumbnail_url: null,
    source_name: "バスケットボールキング",
    created_at: "2026-02-20T15:30:00+09:00",
    updated_at: "2026-02-20T15:30:00+09:00",
  },
  {
    id: id("news", 7),
    source: "media",
    title: "B2注目チーム：横浜エクセレンスの強さの秘密に迫る",
    url: "https://example.com/news/yokohama-ex-analysis",
    published_at: "2026-02-17T12:00:00+09:00",
    thumbnail_url: null,
    source_name: "月刊バスケットボール",
    created_at: "2026-02-17T12:30:00+09:00",
    updated_at: "2026-02-17T12:30:00+09:00",
  },
  {
    id: id("news", 8),
    source: "media",
    title: "M.ジョンソン（横浜EX）がB2得点ランク2位に浮上",
    url: "https://example.com/news/johnson-scoring",
    published_at: "2026-02-14T18:00:00+09:00",
    thumbnail_url: null,
    source_name: "スポーツナビ",
    created_at: "2026-02-14T18:30:00+09:00",
    updated_at: "2026-02-14T18:30:00+09:00",
  },
  {
    id: id("news", 9),
    source: "media",
    title: "Bリーグ B2リーグ 2月第3週 結果まとめ",
    url: "https://example.com/news/b2-week3-feb",
    published_at: "2026-02-11T10:00:00+09:00",
    thumbnail_url: null,
    source_name: "Yahoo!ニュース",
    created_at: "2026-02-11T10:30:00+09:00",
    updated_at: "2026-02-11T10:30:00+09:00",
  },
  {
    id: id("news", 10),
    source: "media",
    title: "横浜エクセレンス 田中大輝「チーム一丸で上を目指す」",
    url: "https://example.com/news/tanaka-interview",
    published_at: "2026-02-08T14:00:00+09:00",
    thumbnail_url: null,
    source_name: "バスケットカウント",
    created_at: "2026-02-08T14:30:00+09:00",
    updated_at: "2026-02-08T14:30:00+09:00",
  },
];
...
export const mockVideos: Video[] = [
  {
    ...
    title: "【ハイライト】横浜エクセレンス vs 東京エクセレンス GAME1｜2/21",
    published_at: "2026-02-21T23:30:00+09:00",
  ...
  },
  {
    ...
    title: "【ハイライト】バンビシャス奈良 vs 横浜エクセレンス GAME2｜2/15",
    published_at: "2026-02-15T23:30:00+09:00",
  ...
  },
  {
    ...
    title: "【ハイライト】バンビシャス奈良 vs 横浜エクセレンス GAME1｜2/14",
    published_at: "2026-02-14T23:30:00+09:00",
  ...
  {
    id: id("video", 4),
    video_id: "jkl456mno78",
    title: "【選手インタビュー】マイケル・ジョンソン「横浜のファンが力になる」",
    published_at: "2026-02-12T18:00:00+09:00",
    thumbnail_url: "https://img.youtube.com/vi/jkl456mno78/maxresdefault.jpg",
    game_id: null,
    created_at: "2026-02-13T00:00:00+09:00",
    updated_at: "2026-02-13T00:00:00+09:00",
  },
  {
    id: id("video", 5),
    video_id: "pqr012stu34",
    title: "【ハイライト】横浜エクセレンス vs ヴェルカ鹿児島 GAME2｜2/8",
    published_at: "2026-02-08T23:30:00+09:00",
    thumbnail_url: "https://img.youtube.com/vi/pqr012stu34/maxresdefault.jpg",
    game_id: id("game", 22),
    created_at: "2026-02-09T00:00:00+09:00",
    updated_at: "2026-02-09T00:00:00+09:00",
  },
];
...
export const mockGameComments: GameComment[] = [
  {
    ...
    game_id: id("game", 25),
    content:
      "横浜EXが東京EXに85-78で勝利。第1Qから主導権を握り、マイケル・ジョンソンが16得点11リバウンドのダブルダブルを記録。佐藤健太も18得点と好調で、チーム全体のシュート精度が高かった。第3Qに一度追い上げを許すも、第4Qに田中大輝のゲームメイクで突き放した。ホーム横浜武道館に2,700人が詰めかけ、今季最多観客数を更新した。",
  ...
  },
  {
    ...
    game_id: id("game", 24),
    content:
      "横浜EXがアウェイでバンビシャス奈良に91-84で勝利し、連敗を1で止めた。渡辺龍一が22得点と奮闘し、マイケル・ジョンソンが18得点10リバウンドのダブルダブル。前日の敗戦からディフェンスの強度を高め、第1Qから積極的にオフェンスを展開。終盤は奈良の追い上げにも冷静に対処し、チーム力で勝ち切った。",
    model: "gemini-2.0-flash",
...
export const mockMascot: Mascot = {
  ...
  profile_json: {
    ...
    description:
      "横浜エクセレンスの公式マスコットキャラクター。チームカラーのグリーンをまとい、ホームゲームでファンを盛り上げる人気者。",
  },
  images_json: [],
  created_at: "2025-10-01T00:00:00+09:00",
  updated_at: "2025-10-01T00:00:00+09:00",
